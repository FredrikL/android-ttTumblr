 ...
 * 
 * Intents received by this service (prefixed with package name): * POST_TEXT -
...
public class TumblrService extends IntentService {
	...
	/**
	 * doPhotoPost - posts a photo (given extras). Extras: 'photo' - Uri,
	 * 'caption' - String.
	 */
	...
	private void doVideoPost(Intent i) {
		...
		if (video != null) {
			...
			Log.d(TAG, "no data to post");
		}
		stopForegroundCompat(true);
	}

	/**
	 * doConversationPost - posts a conversation. Extras: 'title' - String,
	 * 'conversation' - String.
	 */
	...
	/**
	 * doQuotePost - posts a quote Extras: 'quote' - String, 'source' - String
	 * (optional).
	 */
	...
	/**
	 * doUrlPost - posts a link; Extras: 'link' - String, 'name' - String,
	 * 'description' - String
	 */
